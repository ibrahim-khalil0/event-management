...
const Banner = () => {
    return (
        <div style={{backgroundImage: `url(${bannerImg})`}} className='h-screen mt-[-90px] grid place-items-center bg-fixed bg-cover'>
            <div className='relative z-20 text-white md:px-60'>
                <h1 className='text-7xl font-semibold text-center'>Your Perfect Wedding, <br></br> Our Impeccable Management</h1>
